...
It's because adding Zbin and t into the model as dummy variables captures the heterogeneity in group and time effects on individual labour decisions. Equivalently, we are controlling for the group and time effects.
