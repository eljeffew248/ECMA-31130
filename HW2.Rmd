...
$$
We do a probit of $lfp$ on $z_i$ to get $\delta_0$ and $\delta$.
```{r, results = 'hide'}
...
We see that our estimated coefficients indeed correspond to our results before when we set $a=0$. But now our model have $a=1$.
